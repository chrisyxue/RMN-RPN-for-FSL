...
def get_mini_imagenet_data_loader(task, num_per_class=1, split='train',shuffle = False,train_query_argue=False):
    ...
    # For support samples, we do not use DA
    if split == 'train':
    ...
    # For query samples, we only use DA in the meta-training phrase
    else:
